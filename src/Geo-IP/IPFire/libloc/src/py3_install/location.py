...
class CLI(object):
	def parse_cli(self):
		...
		parser.add_argument("--database", "-d",
			default="F:/gv/VC_project/ws_trace/src/Geo-IP/IPFire/libloc/src/database.db", help=_("Path to database"),
		)

		# public key
		parser.add_argument("--public-key", "-k",
			default="F:/gv/VC_project/ws_trace/src/Geo-IP/IPFire/libloc/src/signing-key.pem", help=_("Public Signing Key"),
		)
