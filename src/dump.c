...
/*
   ...
   * 3950.487 msec: g:/mingw32/src/inet/curl/lib/sendf.c(319) (Curl_recv_plain+37):
     ...
     0000: 53 14 C5 31 C0 1B 0A 7B CC BC CF 79 97 99 FF E2 S.Å1A..{I¼Iy-tÿâ
     0010: 3E 23 C4 78 8F 11 E2 3C 47 88 F1 1E 10 E0 E8 AD >#Äx?.â<G^ñ..àè_
     0020: DB FC 47 88 F0 C7 FF FD 38 DD 86 32 11 FF FD 3A UüG^dÇÿy8Y+2.ÿy:
     0030: 31 51 98 0F C9 CB 15 08 B5 0A 60 6D 39 6F D3 4F 1Q~.ÉE..µ.`m9oOO
     0040: FF 80 62 60 96 AB A9 A9 91 3C 0F 3C 47 88 C1 2E ÿ?b`-«cc'<.<G^A.
     <5376 more bytes...>

   * 4155.075 msec: g:/mingw32/src/inet/curl/lib/sendf.c(319) (Curl_recv_plain+37):
     recv (1488, 0x017B064C, 16384, 0) --> 2720 bytes.
     0000: 55 8E 06 3B F4 51 C0 C7 7E A3 86 3B 9F C5 F3 D8 UZ.;ôQAÇ~£+;YÅóØ
     0010: 84 B1 44 47 C8 8B C4 51 B2 3A B1 63 25 0E F8 96 "±DGE<ÄQ²:±c%.ø-
     0020: 31 18 A8 9F 3C B9 DB CF 79 EB 3D 62 12 37 9B 54 1."Y<1UIyë=b.7>T
     0030: FF F8 20 53 FE 61 E9 4E 1A E8 23 13 A6 25 C0 95 ÿø StaéN.è#.¦%A
     0040: EA 7A 8C B0 D4 7C B8 8C 77 D1 73 D1 DC FE 25 90 êzO°O|,OwÑsÑÜt%?
